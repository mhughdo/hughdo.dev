  ...
  return (
    <div className='flex justify-center'>
      <h1 className='text-8xl font-semibold'>
        ...
        <span
          data-before="I'm"
          className='before:text-fill-color relative before:absolute before:bottom-0 before:right-0 before:top-[7px] before:z-0  before:block before:w-full before:animate-im-text-background before:bg-geist-text-gradient before:bg-gradient-to-b before:to-white before:bg-clip-text before:text-center before:content-[attr(data-before)]'>
        ...
        <span
          data-before='Hugh Do'
          className='fill-color relative block text-center before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:z-0 before:block before:w-full before:animate-hughdo-text-background before:bg-geist-text-gradient before:bg-gradient-to-b before:to-white before:bg-clip-text before:text-center before:content-[attr(data-before)]'>
