      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            className='relative mt-4 grid grid-cols-2 gap-x-8 gap-y-2 rounded-xl bg-zinc-50 px-6 py-4 text-sm text-black after:absolute after:left-[47%] after:top-[-3%] after:h-[15px] after:w-[15px] after:rotate-45 after:bg-zinc-50 dark:bg-white dark:after:bg-white'
