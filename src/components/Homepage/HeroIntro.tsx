      ...
      <span className='relative whitespace-nowrap'>
        ...
        <svg
          ...
          <m.path
            ...
            strokeDasharray='0 1'
            d='M43.276 47.002s-39.06-.82-42-18.5c-3.217-19.34 22.395-27.374 42-27.5 17.922-.115 40.766 4.594 40 22.5-.788 18.404-44 17-44 17'></m.path>
        </svg>
      </span>{' '}
      ...
      <span className='relative whitespace-nowrap'>
        ...
        <svg
          ...
          <m.path
            ...
            strokeDasharray='0 1'
            d='M1 3.409S50.376-.539 85 1.673c13.942.891 16.501 3.618 30.5 3.472 12.647-.133 19.355-3.662 32-3.472 11.105.168 14.5 6.596 28 3.472C189 2.02 191 3.409 191 3.409'></m.path>
        </svg>
      </span>
      , and more through{' '}
      <span className='relative whitespace-nowrap'>
