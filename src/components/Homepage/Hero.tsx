  ...
  return (
    <div
      className={clsx(
        ...
        'before:dotted-line-mask before:absolute before:left-[calc(var(--line-offset)/2*-1)] before:top-0 before:h-[var(--line-width)] before:w-0 before:animate-intro-line-width before:bg-horizontal-intro-line before:bg-horizontal-intro-line-size'
      )}>
      ...
      <HeroTitle className='after:dotted-line-mask relative after:absolute after:bottom-[-10px] after:left-[calc(var(--line-offset)/2*-1)] after:h-[var(--line-width)] after:w-0 after:animate-intro-line-width after:bg-horizontal-intro-line after:bg-horizontal-intro-line-size' />
      <div
        ...
        aria-hidden='true'
      />
      <HeroIntro className='after:dotted-line-mask relative after:absolute after:bottom-0 after:left-[calc(var(--line-offset)/2*-1)] after:h-[var(--line-width)] after:w-0 after:animate-intro-line-width after:bg-horizontal-intro-line after:bg-horizontal-intro-line-size' />
      <div
